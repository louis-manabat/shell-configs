# Generated by Powerlevel10k configuration wizard on 2022-12-22 at 22:39 AEDT.
...
# 24h time, 2 lines, disconnected, left frame, white-ornaments, sparse, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS5VICMD,VIVIS,VIOWR}_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=171
